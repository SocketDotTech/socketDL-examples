...
contract TestAppChainToken is Test {
    ...
    function _deployNonAppChainContracts(
        ...
        nonAppChainCtx_.token = new NonMintableToken("Moon", "MOON", 18);
    ...
    function _connectNonAppChainPlugs(NonAppChainContext storage nonAppChainCtx_) internal {
    ...
    function _setNonAppChainLimits(NonAppChainContext storage nonAppChainCtx_) internal {
    ...
    function _setAppChainLimits() internal {
        Controller.UpdateLimitParams[] memory u = new Controller.UpdateLimitParams[](8);
